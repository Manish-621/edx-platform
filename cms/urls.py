...
urlpatterns = oauth2_urlpatterns + [
    ...
    #author:Manish
    re_path(fr'^settings/saveCourseCustomDetails/?$', contentstore_views.saveCourseCustomDetails,
            name='settings_handler_saveCourseCustomDetails'),   
    re_path(fr'^settings/getCourseCustomDetails/{settings.COURSE_KEY_PATTERN}?$', contentstore_views.getCourseCustomDetails,
