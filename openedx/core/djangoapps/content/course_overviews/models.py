...
class CourseCustomDetails(models.Model):
    # User Added fields - Author : Manish
    ...
    course_instructions = models.TextField(null=True, blank=True)
...
class CourseOverview(TimeStampedModel):
    ...
    Duration = models.IntegerField(default = 60)
    FocusArea = models.TextField(default='C++')
    ...
    def __str__(self):
        ...
        return str(self.id)
    #User added method; Author:Manish
