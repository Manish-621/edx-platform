...
def endExamView(request) :
    return render(None,'end-exam-page.html')
...
def timedExams(request):
    ...
    return render(None,'timed-exams.html', context)
...
def examResult(request,id):
    ...
    return render(None,'timed-exam-attempts.html', context)
...
def get_exam_details(request, id):
    ...
    return render(None,'student-exam-details.html', context)